...
\begin{frame}{Intro}
    \begin{center}
    \includegraphics[width=0.7\textwidth]{GooFitSnake}
    \end{center}
...
%D0[P]{K*(1410)bar0{K-,pi+},rho(770)0{pi+,pi-}}   0 0.059 0.1 0 -0.370 0.1
%...
...
%a(1)(1260)+::Spline::Gamma::0 2 0.00 0
%a(1)(1260)+::Spline::Gamma::1 2 0.000133698 0
%a(1)(1260)+::Spline::Gamma::2 2 0.000784943 0
