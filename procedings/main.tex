...
GooFit has preliminary support for decays written in the DecayLanguage syntax as implemented in AmpGen \cite{lib:AmpGen}, primarily implemented as a standalone Python package in the SciKit-HEP organization.
